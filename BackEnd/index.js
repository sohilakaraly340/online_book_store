...
const wishListController=new WishListController(wishListRepository,itemRepository ,userRepository);
...
app.use(`${process.env.API_URL}admin`, adminRouter(itemController,userController,categoryController));
